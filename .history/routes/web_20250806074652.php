...
Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        // URL akan menjadi /admin/events, /admin/events/create, dst.
        // Nama route akan menjadi admin.events.index, admin.events.create, dst.
        Route::resource('events', EventController::class);

        // URL akan menjadi /admin/events/{event}/guests
